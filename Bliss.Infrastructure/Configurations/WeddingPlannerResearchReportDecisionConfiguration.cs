...
public sealed class WeddingPlannerResearchReportDecisionConfiguration
    : IEntityTypeConfiguration<WeddingPlannerResearchReportDecision>
{
    public void Configure(EntityTypeBuilder<WeddingPlannerResearchReportDecision> builder)
    {
        builder.ToTable("WeddingPlannerResearchReportDecisions");
        ...
        builder.HasIndex(x => x.ResearchReportVersionId);
        ...
        builder.HasOne(x => x.Workspace)
            .WithMany(x => x.ResearchReportDecisions)
