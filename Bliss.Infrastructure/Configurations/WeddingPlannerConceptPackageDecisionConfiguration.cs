...
public sealed class WeddingPlannerConceptPackageDecisionConfiguration
    : IEntityTypeConfiguration<WeddingPlannerConceptPackageDecision>
{
    public void Configure(EntityTypeBuilder<WeddingPlannerConceptPackageDecision> builder)
    {
        builder.ToTable("WeddingPlannerConceptPackageDecisions");
        builder.HasKey(x => x.Id);

        builder.Property(x => x.Decision).IsRequired().HasMaxLength(32);
        builder.Property(x => x.SelectedConceptId).HasMaxLength(32);
        ...
        builder.HasIndex(x => x.ConceptPackageVersionId);
        ...
        builder.HasOne(x => x.Workspace)
            .WithMany(x => x.ConceptPackageDecisions)
