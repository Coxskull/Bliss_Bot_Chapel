...
public sealed class WeddingPlannerColorProfileDecisionConfiguration : IEntityTypeConfiguration<WeddingPlannerColorProfileDecision>
{
    public void Configure(EntityTypeBuilder<WeddingPlannerColorProfileDecision> builder)
    {
        builder.ToTable("WeddingPlannerColorProfileDecisions");
        ...
        builder.HasIndex(x => x.ColorProfileVersionId);
        ...
        builder.HasOne(x => x.Workspace)
            .WithMany(x => x.ColorProfileDecisions)
